            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="widget_content">
                    ...
                    <?php foreach ($recent as $kos) { ?>
                        ...
                        <li><i class="fa fa-caret-right"></i> <a href="<?php echo base_url()."index.php/user/lihat_kos/".$kos->kd_kos_t; ?>"><?php echo $kos->nm_kos_t; ?><span>Rp <?php echo number_format($kos->hrg_ks,0,".",".") ?></span></a></li>
                       <?php } ?>
                </div>
            </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                    ...
                    <ul class="tweet_list">
                     <?php foreach ($kosl as $ksl) { ?>
                        <li class="tweet_content item">
                            ...
                            <p class="tweet_link"><a href="<?php echo base_url()."index.php/user/lihat_kos/".$ksl->kd_kos_t; ?>">Kos Pria </a></p>
                    ...
                    <ul class="tweet_list">
                     <?php foreach ($kosp as $ksp) { ?>
                        <li class="tweet_content item">
                            ...
                            <p class="tweet_link"><a href="<?php echo base_url()."index.php/user/lihat_kos/".$ksp->kd_kos_t; ?>">Kos Wanita </a></p>
