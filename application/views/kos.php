                ...
                <ul class="nav navbar-nav">
                                <li class="kat"><a href="#" class="kat_a">Kategori Kos</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?php echo base_url()."index.php/kos/kategori/Wanita"?>">Kos Wanita</a></li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="dreamz-team">
                        ...
                        <div class="team_prof">
                           ...
                           <center> <p class="detail"><a href="<?php echo base_url()."index.php/kos/lihat_kos/".$kos->kd_kos_t; ?>" class="btn btn-default btn-lg">Detail</a></p></center>
                        </div>
                    </div>
                </div>
